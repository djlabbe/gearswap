...
function user_setup()
    ...
    state.WeaponSet = M{['description']='Weapon Set', 'Naegling', 'Nuking'}
...
function init_gear_sets()
    ...
    sets.engaged.Acc.DT = set_combine(sets.engaged.HighAcc, sets.engaged.Hybrid)
