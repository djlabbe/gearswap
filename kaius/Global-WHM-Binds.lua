...
send_command('bind @1 input //send @others /ma "Cure V" <t>')
send_command('bind @2 input //send @others /ma "Cure V" <t>')
send_command('bind @3 input //send @others /ma "Curaga IV <t>')
