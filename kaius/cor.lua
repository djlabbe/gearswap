...
function user_setup()
    ...
    gear.Empyrean_Head = { name= "Chasseur's Tricorne +1" }
    gear.Empyrean_Body = { name= "Chasseur's Frac +1" }
    gear.Empyrean_Hands = { name= "Chasseur's Gants +1" }
    gear.Empyrean_Legs = { name= "Chasseur's Culottes +1" }
...
function init_gear_sets()
    ...
    sets.engaged.DW.Acc.MaxHastePlus = set_combine(sets.engaged.DW.Acc.MaxHaste, {back=gear.COR_DW_Cape})
