...
function user_setup()
    ...
    state.WeaponSet = M{['description']='Weapon Set', 'Ataktos', 'Fomalhaut_M', 'Fomalhaut_R', 'Molybdosis_M', 'Molybdosis_R', }
    state.WeaponLock = M(false, 'Weapon Lock')

    gear.RAbullet = "Chrono Bullet"
    gear.RAccbullet = "Chrono Bullet" -- Devastating
    gear.WSbullet = "Chrono Bullet"
    gear.MAbullet = "Orichalc. Bullet" -- Living
    gear.QDbullet = "Orichalc. Bullet" -- Living
    options.ammo_warning_limit = 10

    gear.Artifact = { }
    gear.Artifact.Body = { name= "Laksamana's Frac +3" }

    gear.Relic = { }
    gear.Relic.Head = { name= "Lanun Tricorne +3" }
    gear.Relic.Body = { name= "Lanun Frac +3" }
    gear.Relic.Hands = { name= "Lanun Gants +3" }
    gear.Relic.Legs = { name= "Lanun Trews +3" }
    gear.Relic.Feet = { name= "Lanun Bottes +3" }

    gear.Empyrean = { }
    gear.Empyrean.Head = { name= "Chasseur's Tricorne +1" }
    gear.Empyrean.Body = { name= "Chasseur's Frac +1" }
    gear.Empyrean.Hands = { name= "Chasseur's Gants +1" }
    gear.Empyrean.Legs = { name= "Chasseur's Culottes +1" }
    gear.Empyrean.Feet = { name= "Chasseur's Bottes +1" }
...
function init_gear_sets()
    ...
    sets.precast.CorsairRoll["Caster's Roll"] = set_combine(sets.precast.CorsairRoll, {legs=gear.Empyrean.Legs})
    sets.precast.CorsairRoll["Courser's Roll"] = set_combine(sets.precast.CorsairRoll, {feet=gear.Empyrean.Feet})
    sets.precast.CorsairRoll["Blitzer's Roll"] = set_combine(sets.precast.CorsairRoll, {head=gear.Empyrean.Head})
    sets.precast.CorsairRoll["Tactician's Roll"] = set_combine(sets.precast.CorsairRoll, {body=gear.Empyrean.Body})
    sets.precast.CorsairRoll["Allies' Roll"] = set_combine(sets.precast.CorsairRoll, {hands=gear.Empyrean.Hands})
    ...
    --     ring1={name="Eshmun's Ring", bag="wardrobe7"}, --20
    --     ring2={name="Eshmun's Ring", bag="wardrobe8"}, --20
    ...
    sets.Molybdosis_M.Acc = {main="Rostam", sub="Tauret", ranged="Molybdosis"}
    sets.Molybdosis_R = {main="Rostam", sub="Tauret", ranged="Molybdosis"}
    sets.Molybdosis_R.Acc = {main="Tauret", sub="Tauret", ranged="Molybdosis"}
    -- sets.Armageddon_M = {main="Naegling", sub="Tauret", ranged="Armageddon"}
    -- sets.Armageddon_M.Acc = {main={name="Rostam", bag="wardrobe7"}, sub={name="Rostam", bag="wardrobe8"}, ranged="Armageddon"}
    -- sets.Armageddon_R = {main="Lanun Knife", sub="Kustawi +1", ranged="Armageddon"}
    -- sets.Armageddon_R.Acc = sets.Armageddon_R
    sets.Fomalhaut_M = {main="Rostam", sub="Gleti's Knife", ranged="Fomalhaut"}
    sets.Fomalhaut_M.Acc = {main="Rostam", sub="Gleti's Knife", ranged="Fomalhaut"}
    ...
    sets.Ataktos.Acc = {main="Naegling", sub="Gleti's Knife", ranged="Anarchy +2"}
