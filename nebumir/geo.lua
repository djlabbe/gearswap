...
function user_setup()
    ...
    gear.Relic.Feet = { name= "Bagua Sandals +3" }
...
function init_gear_sets()
    ...
    sets.precast.JA['Full Circle'] = {head=gear.Empyrean.Head}
    ...
    sets.precast.FC['Elemental Magic'] = set_combine(sets.precast.FC, {hands=gear.Relic.Hands})
   ...
   sets.midcast.Geomancy = {
    ...
    sets.PetHP = {head=gear.Relic.Head}
